...
namespace nunit_lab
{
    ...
    public class LoginStepDefinitions
    {
        ...
        [When(@"\[I enter in login field ""([^""]*)"" and enter in the password field ""([^""]*)""]")]
        public void WhenIEnterInLoginFieldAndEnterInThePasswordField(string user, string user1)
        {
            throw new PendingStepException();
        }

        [Then(@"\[I go to HomePage]")]
        public void ThenIGoToHomePage()
        {
